...
mock_rag_cloud.generate_draft_response = AsyncMock(return_value="")
...
class TestGenerateSummaryForProfessional:
    ...
    async def test_successful_generation(self):
        ...
        with patch(
            ...
            new_callable=AsyncMock,
            return_value="Raw RAG draft response",
        ), patch(
    ...
    async def test_returns_all_required_keys(self):
        ...
        expected_keys = {"patient_context", "chat_summary", "draft_response", "requires_approval"}
