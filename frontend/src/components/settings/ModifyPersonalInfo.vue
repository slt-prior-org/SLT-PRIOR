        ...
        <div class="form-grid">
          <div class="form-card">
            <h3 class="form-card-title">
              {{ $t("modifyPersonalInfo.basicInfo") }}
            </h3>
          ...
          <div class="form-card">
            <h3 class="form-card-title">
              {{ $t("modifyPersonalInfo.healthInfo") }}
            </h3>
            <label class="input-label">
          ...
          <div class="form-card">
            <h3 class="form-card-title">
              {{ $t("modifyPersonalInfo.medicalInfo") }}
            </h3>
...
const handleSubmit = async () => {
  ...
  const bp = {
    ...
    diastolic:
      formData.bp_diastolic === "" ? null : Number(formData.bp_diastolic),
  }
  ...
  try {
    ...
    message.value =
      error?.response?.data?.detail || t("modifyPersonalInfo.saveError")
